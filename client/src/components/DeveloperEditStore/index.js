            ...
            <div className="dropdown-container box">
              <Col className="dropdown-box box">
                ...
                >
                  ...
                  <Dropdown.Item className="mall-style-choice" eventKey="ARTS">
                    ARTS
                  </Dropdown.Item>
                  <Dropdown.Item
                    className="mall-style-choice"
                  ...
                  <Dropdown.Item className="mall-style-choice" eventKey="FOOD">
                    FOOD
                  </Dropdown.Item>
                  <Dropdown.Item
                    className="mall-style-choice"
                    eventKey="FROZEN-TREATS"
                  >
                    FROZEN TREATS
                  </Dropdown.Item>
                  <Dropdown.Item
                    className="mall-style-choice"
                    eventKey="FULL-SERVICE-RESTAURANT"
                  >
                    FULL SERVICE RESTAURANT
                  </Dropdown.Item>
                  <Dropdown.Item
                    className="mall-style-choice"
                    eventKey="HAPPY-HOUR-BAR"
                  >
                    HAPPY HOUR BAR
                  </Dropdown.Item>
                  <Dropdown.Item
                  ...
                  <Dropdown.Item className="mall-style-choice" eventKey="HOME">
                    HOME
                  </Dropdown.Item>
                  <Dropdown.Item
                    className="mall-style-choice"
                    eventKey="KIDS-APPAREL"
                  >
                    KIDS APPAREL
                  </Dropdown.Item>
                  <Dropdown.Item
                  ...
                  <Dropdown.Item className="mall-style-choice" eventKey="OTHER">
                    OTHER
                  </Dropdown.Item>
                  <Dropdown.Item className="mall-style-choice" eventKey="PETS">
                    PETS
                  </Dropdown.Item>
                  <Dropdown.Item
                    className="mall-style-choice"
                    eventKey="QUICK-BITES"
                  >
                    QUICK BITES
                  </Dropdown.Item>
                  <Dropdown.Item
                  ...
                  <Dropdown.Item className="mall-style-choice" eventKey="SHOES">
                    SHOES
                  </Dropdown.Item>
                  <Dropdown.Item
                    className="mall-style-choice"
                    eventKey="SPECIALTY-FOOD"
                  >
                    SPECIALTY FOOD
                  </Dropdown.Item>
                  <Dropdown.Item
